...
<body class="bg-gray-50 font-['Inter']">
                    ...
                    <div id="step3" class="step-content hidden">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-gray-400 transition-colors duration-200 relative">
                                    ...
                                    <p class="text-xs text-gray-500">First image will be the primary image. Allowed: JPG, PNG, GIF, WEBP</p>
                                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Image preview setup
            setupImagePreview('input[name="images[]"]', 'imagePreview');
            setupImagePreview('#editModal input[name="images[]"]', 'editImagePreview');
